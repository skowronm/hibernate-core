...
public class EntitiesConfigurator {
    public EntitiesConfigurations configure(Configuration cfg, ReflectionManager reflectionManager,
                                            ...
                                            AuditStrategy auditStrategy, CollectionMapperResolver collectionMapperResolver,
        ...
        AuditMetadataGenerator auditMetaGen =
                new AuditMetadataGenerator(cfg, globalCfg, verEntCfg, auditStrategy, collectionMapperResolver,
